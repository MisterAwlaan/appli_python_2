...
def menu():
    ...
    bouton_quitter = Button(frame, text="Aurevoir", font=("Courrier", 25), bg="white", fg="#4351ee", command=root.quit)
...
def menu_utilisateur(pseudo, mots_de_passe):
    ...
    bouton_quitter = Button(frame, text="Quitter", font=("Courrier", 25), bg="white", fg="#4351ee", command=root.quit)
